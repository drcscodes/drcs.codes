...
\label{sec:org59e3298}

\begin{frame}[label={sec:org54d9957}]{Languages and Computation}
...
\begin{frame}[label={sec:org538b3b3}]{Values}
\begin{center}
\includegraphics[height=.7\textheight]{./value-uga-shirt.jpeg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge95de0d},fragile]{Expressions}
 \begin{description}
...
\begin{frame}[label={sec:orga58c3fb},fragile]{Types}
...
\begin{frame}[label={sec:org4fe7d47},fragile]{Variables}
...
\begin{frame}[label={sec:org6ed78d7},fragile]{Keywords}
...
\begin{frame}[label={sec:org8500c38},fragile]{Assignment Semantics}
...
\begin{frame}[label={sec:org5e23e20},fragile]{Types as Interpretations of Bits}
...
\begin{frame}[label={sec:org01cf459},fragile]{Types as Sets of Values}
 \begin{itemize}
...
\begin{frame}[label={sec:org589883e},fragile]{Aside: The Sizes of Types}
...
\begin{frame}[label={sec:orgec2dba5},fragile]{Types as Sets of Operations}
...
\begin{frame}[label={sec:org2574864},fragile]{Overloaded Operators}
...
\begin{frame}[label={sec:org1a60658},fragile]{Expression Evaluation}
...
\begin{frame}[label={sec:org17a399f},fragile]{Python is Dynamically Typed}
...
\begin{frame}[label={sec:orgdda67fe},fragile]{Type Conversions}
...
\begin{frame}[label={sec:org8c4b037},fragile]{Assignment Semantics}
...
\begin{frame}[label={sec:org5637327},fragile]{Boolean Values}
...
\begin{frame}[label={sec:orgc9507fb},fragile]{Python Booleans}
...
\begin{frame}[label={sec:org9668db1},fragile]{Truth in Python}
...
\begin{frame}[label={sec:org0cfa41e},fragile]{Short-circuit Evaluation}
