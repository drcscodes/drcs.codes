...
\label{sec:org611b27f}

\begin{frame}[label={sec:org664be8d}]{Languages and Computation}
...
\begin{frame}[label={sec:orgb46ab58}]{Values}
\begin{center}
\includegraphics[height=.7\textheight]{./value-uga-shirt.jpeg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf5cb53d},fragile]{Expressions}
 \begin{description}
...
\begin{frame}[label={sec:org6e0a579},fragile]{Types}
...
\begin{frame}[label={sec:org830f892},fragile]{Variables}
...
\begin{frame}[label={sec:orgf22806d},fragile]{Keywords}
...
\begin{frame}[label={sec:org0e0b500},fragile]{Assignment Semantics}
...
\begin{frame}[label={sec:orgaa4cf8d},fragile]{Types as Interpretations of Bits}
...
\begin{frame}[label={sec:orge48a55a},fragile]{Types as Sets of Values}
 \begin{itemize}
...
\begin{frame}[label={sec:org8070f10},fragile]{Aside: The Sizes of Types}
...
\begin{frame}[label={sec:org24bf8e8},fragile]{Types as Sets of Operations}
...
\begin{frame}[label={sec:orgbde2f9a},fragile]{Overloaded Operators}
...
\begin{frame}[label={sec:org06395ef},fragile]{Expression Evaluation}
...
\begin{frame}[label={sec:org8afc20c},fragile]{Python is Dynamically Typed}
...
\begin{frame}[label={sec:org02f962f},fragile]{Type Conversions}
...
\begin{frame}[label={sec:org446ca32},fragile]{Assignment Semantics}
...
\begin{frame}[label={sec:org40bee32},fragile]{Boolean Values}
...
\begin{frame}[label={sec:org5a53a4a},fragile]{Python Booleans}
...
\begin{frame}[label={sec:orgda4b58b},fragile]{Truth in Python}
...
\begin{frame}[label={sec:org1fd5393},fragile]{Short-circuit Evaluation}
