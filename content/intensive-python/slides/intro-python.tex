...
\label{sec:org03b043a}

\begin{frame}[label={sec:orga258f92}]{Computing}
...
\begin{frame}[label={sec:org7ef31fc}]{Models, Languages, Machines}
...
\begin{frame}[label={sec:org3153aec}]{Python gives you wings!}
\begin{center}
...
\begin{frame}[label={sec:org8ccbff1}]{The Python Language}
\begin{itemize}
...
\begin{frame}[label={sec:orgc17ec3e}]{The Python Name}
\begin{center}
...
\begin{frame}[label={sec:org0cc52c5},fragile]{The \texttt{python3} Program}
