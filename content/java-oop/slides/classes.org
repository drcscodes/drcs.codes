...
In this lecture we'll use a running example stored in a Git repo. Go to [[https://gitlab.com/cs1331/card][https://gitlab.com/cs1331/card]], click on "Clone or download" and copy the clone URL. Then open your terminal and do this:

#+BEGIN_SRC sh
cd cs1331
git clone https://gitlab.com/cs1331/card.git
cd card
#+END_SRC
