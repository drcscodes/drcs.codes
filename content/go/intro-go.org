...
Since the Kernighan and Ritchie classic, /The C Programming Language/[fn:1], it's tradition to start with a program that simply prints ~Hello, world~ to the console.
