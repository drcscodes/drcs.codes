---
template: exercise
title: CS 4400 - Humane Society ER-Relational Mapping Exercise
---
...
- Install [MySQL](@root/databases/ksu/cs6070/mysql.html)
- Install an editor/database tool.  Recommended options on the course [resources page](@root/databases/ksu/cs6070/resources.html)

Given this EER model:

![humane-society.svg](humane-society.svg)
