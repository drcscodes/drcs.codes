---
template: shared
title: AI Programming Project - Search
---

# AI Programming Project: Search
...
The code for this project consists of several Python files, some of which you will need to read and understand in order to complete the assignment, and some of which you can ignore. You can download all the code and supporting files here: [search.zip](search.zip).
...
You will fill in portions of `search.py` and `searchAgents.py` in this assignment. Once you have completed the assignment, you will submit these files to the assignment in D2L as individual `.py` files.

### Evaluation

Your code will be autograded for technical correctness. Please do not change the names of any provided functions or classes within the code.  If you change any of the provided code outside of your assigned work, you may break the autograder.  Be sure the autograder gives you full credit before you turn in your submission.  Your submission will be graded with the supporting files as provided, not including any modifications you make and upload to D2L.  Any files you upload other than the files you're directed to submit in this assignment will be ignored.

### Topics needed for this project:

- Uninformed Search: Problem Solving lecture notes/slides, AIMA 3.1-3.4
- A* Search and Heuristics: Heuristic Search lecture notes/slides, AIMA 3.5-3.6
...
Upload the Python files you edited to the assignment in D2L.
