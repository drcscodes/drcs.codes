...
\runningheader{}
{\small Name: \underline{\hspace{2.8in}} Student account (e.g., msmith3): \underline{\hspace{1.4in}} Section: \underline{\hspace{.5in}}}
{}
...
\question[4] Query giving author first name and last name who have published in CACM.
...
\question[4] Query giving all authors and the books they have edited, including authors who are not book editors.
...
\question[4] Query giving all author first names and last names who have published more than one pub.
...
\question[4] Author of the oldest pub in the database.
...
\question[4] How many rows returned by {\tt select * from book natural join pub}?
...
%% For the questions on this page, use this relation schema and set of functional dependencies $F$:\\

%% $\text{ATL-TRANSIT}(DriverSsn, EmpName, RouteNum, BusId, RouteDate, ServiceDate)$
%% \begin{eqnarray*}
...
\question[4] Transaction processing
