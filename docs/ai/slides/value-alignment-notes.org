...
#+latex: \includegraphics[alt={diverse nazis},height=3.0in]{diverse-nazis.png}
...
#+latex: \includegraphics[alt={ai snake oil book},height=3.0in]{ai-snake-oil-book.jpg}
...
#+latex: \includegraphics[alt={palantir saruman},height=3.0in]{palantir-saruman.png}
...
#+latex: \includegraphics[alt={human compatible book},height=3.0in]{human-compatible-book.jpg}
...
#+latex: \includegraphics[alt={superintelligence book},height=3.0in]{superintelligence-book.jpg}
...
\vspace{.1in}
#+latex: \includegraphics[alt={chatcheapt pineapple pizza advice},height=1.0in]{chatcheapt-pineapple-pizza-advice.pdf}
...
\vspace{.1in}
#+latex: \includegraphics[alt={robot serving pineapple pizza},height=1.2in]{robot-serving-pineapple-pizza.pdf}
...
#+latex: \includegraphics[alt={christopher simpkins headshot 600px},height=1.0in]{christopher-simpkins-headshot-600px.jpg}
#+latex: \includegraphics[alt={chris.simpkins.phd qr},height=1.0in]{chris.simpkins.phd-qr.png}
...
#+latex: \includegraphics[alt={angel demon},height=1.4in]{angel-demon.pdf}
...
#+latex: \includegraphics[alt={robot mtom},height=1.4in]{robot-mtom.pdf}
...
#+latex: \includegraphics[alt={../../deep learning/slides/ReinforceMDP},height=1.6in]{../../deep-learning/slides/ReinforceMDP.pdf}
...
#+latex: \includegraphics[alt={../../deep learning/slides/ReinforceMDP2},height=1.6in]{../../deep-learning/slides/ReinforceMDP2.pdf}
...
#+latex: \includegraphics[alt={../../deep learning/slides/ReinforceMDP3},height=2.0in]{../../deep-learning/slides/ReinforceMDP3.pdf}
