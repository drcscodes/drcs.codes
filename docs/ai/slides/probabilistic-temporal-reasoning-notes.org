...
#+DESCRIPTION: Artificial Intelligence Probabilistic Temporal Reasoning (AIMA 14.1-14.2)
#+KEYWORDS:
#+LANGUAGE:  en
...
#+latex: \includegraphics[alt={aima fig 04_17 vacuum prediction update cycles},height=1.2in]{aima-fig-04_17-vacuum-prediction-update-cycles.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_01 bayes net markov processes},width=0.75\linewidth]{aima-fig-14_01-bayes-net-markov-processes.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_02 bayes net umbrella world},height=1.6in]{aima-fig-14_02-bayes-net-umbrella-world.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_02 bayes net umbrella world},height=1.0in]{aima-fig-14_02-bayes-net-umbrella-world.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_03 smoothing},width=0.75\linewidth]{aima-fig-14_03-smoothing.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_02 bayes net umbrella world},height=1.2in]{aima-fig-14_02-bayes-net-umbrella-world.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_04 forward backward algorithm},height=2.0in]{aima-fig-14_04-forward-backward-algorithm.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_05_a rain state trellis},width=0.75\linewidth]{aima-fig-14_05_a-rain-state-trellis.pdf}
...
Fun homework: [[../../python/projects/markov-chains-recognition/markov-chains-recognition.html][Markov Chains Recognition]]
