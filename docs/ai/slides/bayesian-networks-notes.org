...
#+latex: \includegraphics[alt={aima fig 13_01 bayes net weather cavity},width=0.75\linewidth]{aima-fig-13_01-bayes-net-weather-cavity.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_02 bayes net alarm},width=0.75\linewidth]{aima-fig-13_02-bayes-net-alarm.pdf}
...
#+latex: \includegraphics[alt={deadmau5},height=1.2in]{deadmau5.jpg}
...
#+latex: \includegraphics[alt={aima fig 13_02 bayes net alarm},height=2.0in]{aima-fig-13_02-bayes-net-alarm.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_02 bayes net alarm},height=1.6in]{aima-fig-13_02-bayes-net-alarm.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_03_a bayes net mjabe ordering},width=0.75\linewidth]{aima-fig-13_03_a-bayes-net-mjabe-ordering.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_03_b bayes net mjeba ordering},height=2.0in]{aima-fig-13_03_b-bayes-net-mjeba-ordering.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_10 prob expression tree},height=2.4in]{aima-fig-13_10-prob-expression-tree.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_11 bayes net enumeration algorithm},width=0.75\linewidth]{aima-fig-13_11-bayes-net-enumeration-algorithm.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_10 prob expression tree},width=0.75\linewidth]{aima-fig-13_10-prob-expression-tree.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_12 pointwise multiplication},height=2.0in]{aima-fig-13_12-pointwise-multiplication.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_12 pointwise multiplication},height=1.6in]{aima-fig-13_12-pointwise-multiplication.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_13 bayes net variable elimination algorithm},width=0.75\linewidth]{aima-fig-13_13-bayes-net-variable-elimination-algorithm.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_09 bayes net car insurance},height=2.0in]{aima-fig-13_09-bayes-net-car-insurance.pdf}
