...
- Always end your Python programs and modules with a `.py` extension.
- Always use valid Python identifiers as program/module base names, e.g. `my_prog.py`, NOT `my-prog.py`.
    - Also, in general, don't use spaces in file names.  They create problems for command-line tools.
