---
title: "Java API Guide"
draft: false
layout: "course"
courseName: "Java"
---

# Understanding Java API Documentation

by **Amanda Moreton**, with updates by the staff of CS 1331

### What is an API?

API stands for Application Programming Interface. An API is the way an application programmer uses a library. API documentation contains information for all of the classes that you get with a library, such as the Java standard library included in the Java Development Kit and available to running Java programs in the Java Runtime Environment.

## Navigating API Documentation

To understand API documentation in general we'll look at an API that every Java programmer should know well: the [Java standard library API](https://docs.oracle.com/javase/8/docs/api/index.html).

> Note: this documentation refers to Java 8. Newer versions of Java don't use HTML frames, but the concepts in this guide apply to all API documentation.
