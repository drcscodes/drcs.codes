...
#+latex: \includegraphics[alt={agent smith subway fight},height=3.2in]{agent-smith-subway-fight.jpg}
...
#+latex: \includegraphics[alt={aima fig 02_02 vacuum world},height=0.6in]{aima-fig-02_02-vacuum-world.pdf}
#+latex: \includegraphics[alt={aima fig 02_03 vacuum function},height=3.0in]{aima-fig-02_03-vacuum-function.pdf}
...
#+latex: \includegraphics[alt={aima fig 02_05 agent types},height=3.6in]{aima-fig-02_05-agent-types.pdf}
...
#+latex: \includegraphics[alt={aima fig 02_06 example tasks},height=3.6in]{aima-fig-02_06-example-tasks.pdf}
...
\vspace{-.2in}
\begin{flushright}
#+latex: \includegraphics[alt={aima fig 02_09 reflex agent diagram},height=2.0in]{aima-fig-02_09-reflex-agent-diagram.pdf}
\end{flushright}
...
\begin{flushleft}
#+latex: \includegraphics[alt={aima fig 02_12 model based reflex agent program},height=2.0in]{aima-fig-02_12-model-based-reflex-agent-program.pdf}
\end{flushleft}

\vspace{-.3in}
\begin{flushright}
#+latex: \includegraphics[alt={aima fig 02_11 model based reflex agent diagram},height=1.8in]{aima-fig-02_11-model-based-reflex-agent-diagram.pdf}
\end{flushright}
