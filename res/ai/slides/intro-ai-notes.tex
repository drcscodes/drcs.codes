...
\includegraphics[alt={rodney brooks},height=1.2in]{rodney-brooks.jpg}
...
\end{latex}
\includegraphics[alt={./simon1996sciences cover},height=2.4in]{./simon1996sciences-cover.jpg}
\begin{latex}
...
\label{sec:org24f8f1b}

How do brains process information?

\includegraphics[alt={./aima fig 01_02 computers vs brains},height=2.0in]{./aima-fig-01_02-computers-vs-brains.pdf}
\section{Psychology}
\label{sec:orge901d0e}
...
\includegraphics[alt={ai data center},height=2.0in]{ai-data-center.jpg}
\section{Control theory and cybernetics}
\label{sec:orgb987ff7}

How can artifacts operate under their own control?

\includegraphics[alt={robot hand},height=1.2in]{robot-hand.jpg}
\includegraphics[alt={self driving car},height=1.2in]{self-driving-car.jpg}

\includegraphics[alt={Power Relay 6},height=1.2in]{Power-Relay-6.jpg}

\href{https://www.darpa.mil/research/programs/power}{DARPA POWER Program}
\section{Impact of AI}
\label{sec:orgf22becd}
...
\label{sec:orga55cb19}




\includegraphics[alt={andrew barto},height=1.2in]{andrew-barto.jpg}
...
\includegraphics[alt={rich sutton},height=1.2in]{rich-sutton.jpg}
\href{http://incompleteideas.net/}{Rich Sutton}




\includegraphics[alt={david silver},height=1.2in]{david-silver.jpg}
