...
\question Most people don't like Mondays.  It's so bad that the probability that a randomly chosen person has a full-blown case of The Mondays is $P(M=True) = 0.8$.  The new temp is very concerned with cases of The Mondays, so she's constantly on the lookout.  She is better than a coin flip at detecting The Mondays, so if you have The Mondays, she tells you so 60\% of the time, $P(T=True \mid M=True) = 0.6$. Given the prevalence of The Mondays and the temp's penchant for reporting cases of The Mondays, what is the probability that you have The Mondays if the temp sees you and declares:
...
We know $P(t \mid m)$ and $P(m)$ from the problem statement.  We need to calculate $P(t)$, the probability that the temp tells you that you have The Mondays whether you have it or not.  That's the sum of both cases:
...
Thinking intuitively, the temp reporting a case of The Mondays gives better than 50/50 odds of having The Mondays, so the posterior probability that you have The Mondays should be higher than the prior probability, given a positive ``test.''
\end{solution}
