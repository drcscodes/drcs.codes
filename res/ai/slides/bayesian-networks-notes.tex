...
\includegraphics[alt={deadmau5},height=1.2in]{deadmau5.jpg}
...
\includegraphics[alt={aima fig 13_02 bayes net alarm},height=2.0in]{aima-fig-13_02-bayes-net-alarm.pdf}
...
\includegraphics[alt={aima fig 13_02 bayes net alarm},height=1.6in]{aima-fig-13_02-bayes-net-alarm.pdf}
...
\includegraphics[alt={aima fig 13_03_b bayes net mjeba ordering},height=2.0in]{aima-fig-13_03_b-bayes-net-mjeba-ordering.pdf}
...
\includegraphics[alt={aima fig 13_10 prob expression tree},height=2.4in]{aima-fig-13_10-prob-expression-tree.pdf}
...
\includegraphics[alt={aima fig 13_12 pointwise multiplication},height=2.0in]{aima-fig-13_12-pointwise-multiplication.pdf}
\section{Summing out Variables}
\label{sec:orgb36d1fc}



\includegraphics[alt={aima fig 13_12 pointwise multiplication},height=1.6in]{aima-fig-13_12-pointwise-multiplication.pdf}
...
\label{sec:orgde4d793}

Now consider \textbf{multiply-connected} networks such as the car insurance network:


\includegraphics[alt={aima fig 13_09 bayes net car insurance},height=2.0in]{aima-fig-13_09-bayes-net-car-insurance.pdf}
