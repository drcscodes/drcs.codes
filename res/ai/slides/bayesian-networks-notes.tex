...
\usepackage{fontspec}
\usepackage{verbatim, multicol, tabularx, multicol}
...
\author{Christopher Simpkins $\backslash$\ Kennesaw State University}
\date{}
\title{Artificial Intelligence\\\medskip
\large Bayesian Networks}
\hypersetup{
 pdfauthor={Christopher Simpkins $\backslash$\ Kennesaw State University},
...
\label{sec:org64ad152}

\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_01-bayes-net-weather-cavity.pdf}
\end{center}
...
\item John nearly always calls when he hears the alarm, but somb
\end{itemize}

\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_02-bayes-net-alarm.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{deadmau5.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_03_a-bayes-net-mjabe-ordering.pdf}
\end{center}
\section{Knowledge Engineering in Probabilistic Systems}
\label{sec:org1f8af42}
...
\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_03_b-bayes-net-mjeba-ordering.pdf}
\end{center}
...
\end{itemize}
\section{Example: \(P(Burglary \mid JohnCalls=true, MaryCalls=true)\).}
\label{sec:org38a4a14}
...
\section{Caclulation of \(P(b \mid j, m)\)}
\label{sec:org8de6b1d}
...
\section{\(\bm{f}_3(A, B, E)\)}
\label{sec:orgada9290}
...
\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_12-pointwise-multiplication.pdf}
\end{center}
\section{Summing out Variables}
\label{sec:org29690f0}
...
\label{sec:orgc44a331}

With these two basic operations, we can implement the variable elimination algorithm:

\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_13-bayes-net-variable-elimination-algorithm.pdf}
\end{center}
...
\label{sec:org39d3a24}

Now consider \textbf{multiply-connected} networks such as the car insurance network:

\begin{center}
\includegraphics[width=.9\linewidth]{aima-fig-13_09-bayes-net-car-insurance.pdf}
\end{center}

\begin{itemize}
\item Variable elimination can have exponential worst-case time and space complexity in multiply-connected networks.
\item Since inference in Bayes nets includes inference in propositional logic as a special case, Bayes net inference is \textbf{NP-hard}.
\end{itemize}
\section{Closing Thoughts}
\label{sec:org6829ab9}
