...
\pandocbounded{\includegraphics[keepaspectratio]{andrew-barto.jpg}}

\href{https://people.cs.umass.edu/~barto/}{Andrew Barto}
\end{column}

\begin{column}{0.3\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{rich-sutton.jpg}}
\href{http://incompleteideas.net/}{Rich Sutton}
\end{column}

\begin{column}{0.3\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{david-silver.jpg}}
