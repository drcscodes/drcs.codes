...
\label{sec:org5ae562d}


\includegraphics[alt={aima fig 05_01 tic tac toe game tree},height=1in]{aima-fig-05_01-tic-tac-toe-game-tree.pdf}
...
\label{sec:orgdbb9d56}

Intervals show range of possible values at each node,  \([\alpha, \beta]\).


\includegraphics[alt={aima fig 05_05 f alpha beta tree},height=1in]{aima-fig-05_05-f-alpha-beta-tree.pdf}
...
\label{sec:org99a24b6}



\includegraphics[alt={aima fig 05_09 chess horizon effect},height=1in]{aima-fig-05_09-chess-horizon-effect.pdf}
...
\label{sec:orgc55f555}


\includegraphics[alt={aima fig 05_11 mcts algorithm},height=1in]{aima-fig-05_11-mcts-algorithm.pdf}
...
\label{sec:org5ca490a}

White just played (light purple nodes) -- black to play.


\includegraphics[alt={aima fig 05_10 mcts iteration},height=1in]{aima-fig-05_10-mcts-iteration.pdf}
