...
\label{sec:org7c87938}


\includegraphics[alt={agent smith subway fight},height=1in]{agent-smith-subway-fight.jpg}
...
\label{sec:org0993cfb}

An \textbf{agent function} is an external tabulation of the agent's behavior.


\includegraphics[alt={aima fig 02_02 vacuum world},height=1in]{aima-fig-02_02-vacuum-world.pdf}
\includegraphics[alt={aima fig 02_03 vacuum function},height=1in]{aima-fig-02_03-vacuum-function.pdf}


An \textbf{agent program} is an implementation of an agent function inside the agent.
\section{Intelligent Agents}
\label{sec:orgc08c58d}
...
\label{sec:orgde27722}


\includegraphics[alt={aima fig 02_05 agent types},height=1in]{aima-fig-02_05-agent-types.pdf}
\section{Task Environment Design Space}
\label{sec:org81afa50}
...
\label{sec:org3487e8b}


\includegraphics[alt={aima fig 02_06 example tasks},height=1in]{aima-fig-02_06-example-tasks.pdf}
\section{The Structure of Agents}
\label{sec:orgd50101d}
