...
#+latex: \includegraphics[alt={deadmau5},height=1in]{deadmau5.jpg}
...
#+latex: \includegraphics[alt={aima fig 13_02 bayes net alarm},height=1in]{aima-fig-13_02-bayes-net-alarm.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_03_b bayes net mjeba ordering},height=1in]{aima-fig-13_03_b-bayes-net-mjeba-ordering.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_10 prob expression tree},height=1in]{aima-fig-13_10-prob-expression-tree.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_12 pointwise multiplication},height=1in]{aima-fig-13_12-pointwise-multiplication.pdf}
...
#+latex: \includegraphics[alt={aima fig 13_09 bayes net car insurance},height=1in]{aima-fig-13_09-bayes-net-car-insurance.pdf}
