...
#+latex: \includegraphics[alt={aima fig 04_10 vacuum and or search tree},height=1in]{aima-fig-04_10-vacuum-and-or-search-tree.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_12 slippery vacuum search graph},height=1in]{aima-fig-04_12-slippery-vacuum-search-graph.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_14 reachable sensorless vacuum belief states},height=1in]{aima-fig-04_14-reachable-sensorless-vacuum-belief-states.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_15_b local sensing vacuum nondeterministic state transitions},height=1in]{aima-fig-04_15_b-local-sensing-vacuum-nondeterministic-state-transitions.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_18 robot localization},height=1in]{aima-fig-04_18-robot-localization.pdf}
