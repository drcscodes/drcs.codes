...
\label{sec:orgbbbcb16}

\begin{itemize}
\item Agent uncertain about current state, so each state has a probability \(P(s)\).

\item Action outcomes are also uncertain, so the transition model is \(P(s' \mid s, a)\).
\end{itemize}
...
\includegraphics[alt={fight club formula meme},height=1in]{fight-club-formula-meme.png}
\section{The Utility of Money}
\label{sec:org59d4271}
...
\includegraphics[alt={predictably irrational book},height=1in]{predictably-irrational-book.jpg}

\includegraphics[alt={dan ariely},height=1in]{dan-ariely.png}
...
\includegraphics[alt={shepherd chickens},height=1in]{shepherd-chickens.jpg}
