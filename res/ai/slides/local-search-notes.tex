...
\label{sec:orgd2c6d19}

\textbf{Complete-state formulation}: each state has all components of a solution.

\begin{itemize}
\item 8 Queens state: row position for each of 8 columns, e.g., (a) below is `<1, 6, 2, 5, 7, 4, 8, 3>`
\end{itemize}
