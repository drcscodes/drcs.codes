...
#+latex: \includegraphics[alt={aima fig 04_17 vacuum prediction update cycles},height=1in]{aima-fig-04_17-vacuum-prediction-update-cycles.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_02 bayes net umbrella world},height=1in]{aima-fig-14_02-bayes-net-umbrella-world.pdf}
...
#+latex: \includegraphics[alt={aima fig 14_04 forward backward algorithm},height=1in]{aima-fig-14_04-forward-backward-algorithm.pdf}
