...
\label{sec:org4c54086}


\includegraphics[alt={aima fig 07_07 grammar of popositional logic},height=2.4in]{aima-fig-07_07-grammar-of-popositional-logic.pdf}
\section{Semantics of Propositional Logic}
\label{sec:org04992db}
...
\item \textbf{Deduction theorem}: For any sentences \(\alpha\) and \(\beta\), \(\alpha \models \beta\) if and only iff the sentence \(alpha \implies \beta\) is valid.

\item A sentence is \textbf{satisfiable} if it is true in, or satisfied by, \textbf{some} model
\end{itemize}
\section{Inference Rules}
\label{sec:orgeb36e1c}
...
\label{sec:orga17865d}

Functionally equivalent to inference rules.  Left side on top, right side on bottom.


\includegraphics[alt={aima fig 07_11 logical equivalences},height=2.4in]{aima-fig-07_11-logical-equivalences.pdf}
\section{Representational Power of Formal Languages}
\label{sec:orgb9aa457}
...
\includegraphics[alt={aima fig 08_01 ontological epistemological commitments},height=1.2in]{aima-fig-08_01-ontological-epistemological-commitments.pdf}
...
\includegraphics[alt={aima fig 10_01 upper ontology world},height=2.0in]{aima-fig-10_01-upper-ontology-world.pdf}
\section{Events and Time}
\label{sec:orgecf5972}
...
\includegraphics[alt={aima fig 10_02 predicates time intervals},height=1.6in]{aima-fig-10_02-predicates-time-intervals.pdf}
Predicates on time intervals.
\section{Fluents}
\label{sec:org5e0edad}


\includegraphics[alt={aima fig 10_03 schematic object president},height=2.0in]{aima-fig-10_03-schematic-object-president.pdf}
...
\section{Beliefs and Attitudes}
\label{sec:orgb179ae4}
...
This gets out of hand quickly.  Need \textbf{modal logic}, which includes modal operators that take sentences as arguments instead of terms.  \(A\) knows \(P\) becomes:
...
\label{sec:orgdc66d48}

Originally called \textbf{existential graphs}.


\includegraphics[alt={aima fig 10_04 semantic network 4 objects},height=2.4in]{aima-fig-10_04-semantic-network-4-objects.pdf}
\section{Closing Thoughts}
\label{sec:org8d05744}

\begin{itemize}
\item \textbf{Much} more to knowledge-based AI than presented here
...
\begin{itemize}
\item Didn't stop Doug Lennat and his team at \href{https://cyc.com/}{Cycorp} from trying.
\end{itemize}
\end{itemize}
\end{itemize}
\end{document}
