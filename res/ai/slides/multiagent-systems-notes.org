...
#+DESCRIPTION: Artificial Intelligence Multiagent Systems (AIMA 18.1, MAS 1-2)
#+KEYWORDS:
#+LANGUAGE:  en
...
#+latex: \includegraphics[alt={mas book},height=2.0in]{mas-book.jpg}
...
#+latex: \includegraphics[alt={marl book},height=2.0in]{marl-book.jpg}
...
#+latex: \includegraphics[alt={doubles tennis},width=0.75\linewidth]{doubles-tennis.jpg}
...
#+latex: \includegraphics[alt={aima fig 18_01 doubles tennis problem},width=0.75\linewidth]{aima-fig-18_01-doubles-tennis-problem.pdf}
...
#+latex: \includegraphics[alt={tragedy of commons classic},height=1.6in]{tragedy-of-commons-classic.jpg}
...
#+latex: \includegraphics[alt={beautiful mind bar scene},height=1.6in]{beautiful-mind-bar-scene.jpg}
...
#+latex: \includegraphics[alt={aima fig 18_03 ipd fsms},height=1.6in]{aima-fig-18_03-ipd-fsms.pdf}
...
#+latex: \includegraphics[alt={axelrod evolution of cooperation book},height=3.2in]{axelrod-evolution-of-cooperation-book.jpg}
...
#+latex: \includegraphics[alt={kimmel science of revenge book},height=3.2in]{kimmel-science-of-revenge-book.jpg}
...
#+latex: \includegraphics[alt={wolf pack},height=1.6in]{wolf-pack.png}


\vspace{.1in}


#+latex: \includegraphics[alt={rise of wolf 8 book},height=2.0in]{rise-of-wolf-8-book.jpg}
...
#+latex: \includegraphics[alt={Safari_ants},height=1.2in]{Safari_ants.jpg}


\vspace{.1in}


#+latex: \includegraphics[alt={bees honeycomb},height=1.2in]{bees-honeycomb.jpg}
...
#+latex: \includegraphics[alt={bachelor pad prisoners dilemma.},height=2.0in]{bachelor-pad-prisoners-dilemma.jpeg}
