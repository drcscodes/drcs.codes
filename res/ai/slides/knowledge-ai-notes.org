...
#+latex: \includegraphics[alt={aima fig 07_07 grammar of popositional logic},height=2.4in]{aima-fig-07_07-grammar-of-popositional-logic.pdf}
...
#+latex: \includegraphics[alt={aima fig 07_11 logical equivalences},height=2.4in]{aima-fig-07_11-logical-equivalences.pdf}
...
#+latex: \includegraphics[alt={aima fig 08_01 ontological epistemological commitments},height=1.2in]{aima-fig-08_01-ontological-epistemological-commitments.pdf}
...
#+latex: \includegraphics[alt={aima fig 10_01 upper ontology world},height=2.0in]{aima-fig-10_01-upper-ontology-world.pdf}
...
#+latex: \includegraphics[alt={aima fig 10_02 predicates time intervals},height=1.6in]{aima-fig-10_02-predicates-time-intervals.pdf}
...
#+latex: \includegraphics[alt={aima fig 10_03 schematic object president},height=2.0in]{aima-fig-10_03-schematic-object-president.pdf}
...
#+latex: \includegraphics[alt={aima fig 10_04 semantic network 4 objects},height=2.4in]{aima-fig-10_04-semantic-network-4-objects.pdf}
...
- Knowledge-based AI heart of *expert systems*, failure of which led to an AI winter
    ...
    - Knowledge AI fell out of favor, has never really recovered the mantle of AI
        ...
        - Didn't stop Doug Lennat and his team at [[https://cyc.com/][Cycorp]] from trying.
