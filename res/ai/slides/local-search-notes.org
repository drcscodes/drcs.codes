...
#+latex: \includegraphics[alt={aima fig 04_03 8 queens},height=1in]{aima-fig-04_03-8-queens.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_01 state space landscape},height=1in]{aima-fig-04_01-state-space-landscape.pdf}
...
#+latex: \includegraphics[alt={aima fig 04_05 simulated annealing algorithm},height=1in]{aima-fig-04_05-simulated-annealing-algorithm.pdf}
...
#+latex: \includegraphics[alt={aima romania airports},height=1in]{aima-romania-airports.png}
...
#+latex: \includegraphics[alt={../../deep learning/slides/TrainLRMin},height=1in]{../../deep-learning/slides/TrainLRMin.pdf}
...
#+latex: \includegraphics[alt={lp fig 02_01 half planes},height=1in]{lp-fig-02_01-half-planes.pdf}
