...
![](cat-classify.png){height="50%"}[^cs231n]
...
Hyperparameters are parameters of the algorithm, as opposed to the parameters of the model.
...
## Thanks to GANs, everyone can dance!

![Ballet Nerd](ballet-nerd.jpg)[^ChanEtAl]

- [https://www.youtube.com/watch?v=PCBTZh41Ris&t=173s](https://www.youtube.com/watch?v=PCBTZh41Ris&t=173s)

[^ChanEtAl]: [https://arxiv.org/pdf/1808.07371.pdf](https://arxiv.org/pdf/1808.07371.pdf)

## You've been using GenAI for years.

E.g., automatically fixing images.

![I can haz cheezburger?](masked-autoencoder-reconstruction-cat.jpg){height=50%}[^1]

This is an example of *self-supervised* learning: the data examples themselves are the labels.  We remove parts of the examples and train a model to reconstruct the examples.

[^1]: https://nostarch.com/machine-learning-q-and-ai

## You've even been using LLMs for years.

- Modern LLMs based on transformer architecture developed for machine translation.
    - $\{en, fr, de, \dots\} \rightarrow \{en, fr, de, \dots\}$
- Google had a chatbot for years but didn't release it publicly because due to a lack of clear business applications.
    - Remember when Blake Lemoine grabbed his 15 minutes of fame?

    ![It's alive!](blake-lemoine.jpg){height="40%"}

    - The Blake Lemoine kerfuffle once again raised the issue of the [Turing Test](https://academic.oup.com/mind/article-abstract/LIX/236/433/986238).

## Generative AI Hype Cycle

Unfortunately, the public discourse is filled with noise from various grifters:

::::{.columns}
::: {.column width="33%" valign="top"}

hypers,

![](santiago-twitter.jpg){width=95%}

:::
::: {.column width="33%" valign="top"}

charlatans, and
![](matt-schlicht.png){width=100%}

:::
::: {.column width="33%" valign="top"}
doomers.

![](eliezer-twitter.jpg){width=95%}

:::
::::

But that doesn't mean LLMs are useless.

## Whale Detection using Anthropic's Claude Opus
...
- Turned whale recordings into visual representations called spectrograms.
- Used both ConvNets and Claude on the spectograms.
- Used *transfer learning* to speed up training and reduce need for training data.
    - Start with foundation model, like Claude/GPT/etc, trained on massive general data set.
    - Fine-tune foundation model by training on domain-specific data.
...
- That doesn't mean other kinds of AI and ML are irrelevant.
